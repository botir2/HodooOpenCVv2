...
import com.ahqlab.hodooopencv.http.RequestNote;
...
import com.ahqlab.hodooopencv.util.ColorDetectorControllerForAndroid;
...
//                if ( DEBUG ) return hsvMat;
    ...
    public void requestRetrofit(final Context context, List<HodooFindColor> colors) {
        ...
        if ( values.size() >= 11 ) {
            final HsvValue hsvValue = new HsvValue();
           ...
           /* hsvValue.setSg("101");
            ...
            ColorDetectorControllerForAndroid colorDecController = new ColorDetectorControllerForAndroid();

            // fro temp test
           // HsvValue hsv = (hsvValue);

                    HsvValue hsv = (colorDecController.detector(hsvValue));
                    ...
                    if ( hsv != null ) {
                        ...
                        for (int i = 0; i < arr.length; i++) {
                            ...
                            ComburResult result = ComburResult.builder() //ex
                                    .comburTitle(nameList[i]) //comburTitle=SG
                                    .resultMsg(msg[position]) //position=0
                                    .position(i) //resultPosition = 6
                                    .resultPosition( Integer.parseInt(arr[i]) ) //resultMsg=고장뇨
                                    .imgPreStr(name[i].toLowerCase()) //this is for get image form drawable
                                    .resultPosition(Integer.parseInt(arr[i])) //imgs=[2131165331, 2131165332, 2131165333, 2131165334, 2131165335, 2131165336, 2131165337]
                                    .build();
                       ...
                       // System.out.println( " Results : " + results);
                        ...
                        Log.e(TAG, "server error_________________________________________________");
                    }
        }
    }
